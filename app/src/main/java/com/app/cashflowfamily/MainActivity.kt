        ...
        setContent {
            ...
            CashflowFamilyTheme(darkTheme = darkTheme) {
                Surface(
                    ...
                    // App ini didesain untuk layar HP (portrait, dikunci di manifest).
                    // Kalau ter-install di tablet/foldable, cap lebar konten supaya
                    // tidak melebar penuh dan terlihat renggang -- diterapkan sekali
                    // di root, tidak perlu ubah tiap screen satu-satu.
                    Box(
                        modifier = Modifier.fillMaxSize(),
