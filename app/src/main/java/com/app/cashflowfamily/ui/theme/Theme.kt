...
private val LightColorScheme = lightColorScheme(
    ...
    primaryContainer = GreenPrimaryLight.copy(alpha = 0.2f),
    secondary = BlueSecondary,
    onSecondary = GreenOnPrimary,
    secondaryContainer = BlueSecondaryLight.copy(alpha = 0.2f),
...
private val DarkColorScheme = darkColorScheme(
    ...
    primaryContainer = GreenPrimaryDark.copy(alpha = 0.3f),
    secondary = BlueSecondaryLight,
    onSecondary = BlueSecondaryDark,
    secondaryContainer = BlueSecondaryDark.copy(alpha = 0.3f),
    tertiary = BlueSecondaryLight,
    onTertiary = BlueSecondaryDark,
    ...
    onSurfaceVariant = OnBackgroundDark.copy(alpha = 0.7f),
    outline = OutlineDark,
